...
2. The release must include or link to release assets controlled by this project containing the exact corresponding source for copyleft runtime components distributed in the package, including PyMuPDF/MuPDF, nanoPRC, PySide6/Shiboken and the relevant Qt modules.
