...
- Attach the exact corresponding source archives for PyMuPDF/MuPDF, nanoPRC, PySide6/Shiboken and all distributed Qt modules to the GitHub release.
- Preserve the complete NumPy wheel license and its bundled-library notices beside the executable.
